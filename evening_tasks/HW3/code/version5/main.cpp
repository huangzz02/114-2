...
/*
    1. Modify all the
       "system("cls")" parts (only for Windows)
       to "cout << "\033[2J\033[1;1H" << flush;" (ANSL, can be used in Linux and MacOS),
       to be able to run cross-platform
    2. Let the player choose the maze map file at the beginning of the program
       (the maze map file must be in the same directory as the program)
*/